@OslcSchema({
        ...
        @OslcNamespaceDefinition(prefix = "oslcqm"   , namespaceURI = "http://open-services.net/ns/qm#"),
        @OslcNamespaceDefinition(prefix = "oslcasset", namespaceURI = "http://open-services.net/ns/asset#"),
